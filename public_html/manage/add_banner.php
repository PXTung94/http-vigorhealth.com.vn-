...
if($tion=="save"){
	...
	if ($thanhcong){
		...
		$qr="insert into tbl_linksp(hienthi,s_pic,s_text,s_link,s_text_en) values ('$active','$pic_name_slide','$s_text','$s_link','$s_text_en')";
...
$addcat=<<<EOF
	...
	<form action="add_banner.php?act=addcat&tion=save" method="post"  name="FormName" enctype="multipart/form-data"> 
	<ul>
		...
		<li>Hình:<right><input type=file name='picfile' value=''>Max-width: 220px</right></li>
